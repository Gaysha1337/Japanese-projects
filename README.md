...
## Kanji Viewer app:
***An app to learn the kanji for the IB (SL and HL)***
This app will generate a random kanji based on the level you choose: SL (400 kanji for SL), HL (600 kanji: SL + HL extra), HL Extra (200 kanji not in standard)
